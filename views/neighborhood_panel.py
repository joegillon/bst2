...
class NeighborhoodPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        street_pick_panel = self.build_street_pick_panel(self)
        street_picker_layout.Add(street_pick_panel, 1, wx.ALL | wx.EXPAND, 2)
    ...
    def build_nhoods_tb_panel(self, parent):
        ...
        add_nhood_btn.Bind(wx.EVT_BUTTON, self.add_nhood_btn_click)
        layout.Add(add_nhood_btn, 0, wx.ALL, 5)

        drop_nhood_btn = uil.toolbar_button(panel, 'Drop')
        drop_nhood_btn.Bind(wx.EVT_BUTTON, self.drop_nhood_btn_click)
        layout.Add(drop_nhood_btn, 0, wx.ALL, 5)

        save_nhood_btn = uil.toolbar_button(panel, 'Save')
        save_nhood_btn.Bind(wx.EVT_BUTTON, self.save_nhood_btn_click)
    ...
    def build_street_pick_panel(self, parent):
        ...
        tb_panel = self.build_street_pick_tb_panel(panel)
        layout.Add(tb_panel, 0, wx.ALL | wx.EXPAND, 5)

        lst_panel = self.build_street_pick_list_panel(panel)
    ...
    def build_street_pick_tb_panel(self, parent):
        panel = wx.Panel(parent, wx.ID_ANY)
        panel.SetBackgroundColour(gbl.COLOR_SCHEME['tbBg'])
        layout = wx.BoxSizer(wx.HORIZONTAL)
    ...
    def build_street_pick_list_panel(self, parent):
        panel = wx.Panel(parent, wx.ID_ANY)
        panel.SetBackgroundColour(gbl.COLOR_SCHEME['tbBg'])
        layout = wx.BoxSizer(wx.VERTICAL)
    ...
    def add_nhood_btn_click(self, evt):
    ...
    def drop_nhood_btn_click(self, evt):
        uil.inform(self, 'Not yet implemented')

    def save_nhood_btn_click(self, evt):
        uil.inform(self, 'Not yet implemented')
